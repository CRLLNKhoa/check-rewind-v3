...
export default function Mscalculate({ get, set, getMilestone, setMilestone, wt = false }) {
  function tinhDauYeuCau(targetLv, currentLv) {
    ...
    console.log(targetLv, currentLv, currentPrice, targetPrice);
  ...
  return (
    <div className="flex gap-4 items-center flex-wrap">
      ...
      <input
         ...
         disabled={true}
        type="number"
        className={cn("outline-none cursor-not-allowed w-[102px] text-center text-yellow-500 bg-white/40 select-none font-bold")}
